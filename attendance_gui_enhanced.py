...
class AttendanceGUI(QMainWindow):
    ...
    def start_session(self):
        ...
        self.session_status.setText(f"Status: <span style='color: #00B050;'>Recording</span>")
    ...
    def stop_session(self):
        ...
        self.stop_btn.setEnabled(False)
        self.session_status.setText("Status: <span style='color: #FF9800;'>Stopped</span>")
